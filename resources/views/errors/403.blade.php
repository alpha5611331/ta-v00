...
<head>
    ...
    <title>403 – Akses Ditolak | VOXORA</title>
...
<!-- Blob dekoratif -->
<div class="blob" style="width:400px;height:400px;background:var(--coral);top:-80px;left:-100px;" aria-hidden="true"></div>
<div class="blob" style="width:360px;height:360px;background:var(--header);bottom:-60px;right:-80px;" aria-hidden="true"></div>
...
<!-- Main -->
<main id="main-content" role="main" tabindex="-1" aria-label="Akses ke halaman ini ditolak"
    ...
    <div>
        ...
        <div style="margin-top:-clamp(3rem,8vw,6rem);" class="relative z-10">
            ...
            <div class="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6"
                 style="background:var(--peach);" aria-hidden="true">
                <svg class="w-10 h-10 text-black" fill="none" viewBox="0 0 24 24"
            ...
            <p class="text-slate-600 text-base mb-2 max-w-md mx-auto leading-relaxed">
                ...
                Halaman ini mungkin membutuhkan hak akses khusus.
            </p>
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                @else
                    ...
                    <a href="{{ url('/') }}" class="btn-secondary"
                       aria-label="Kembali ke halaman landing">
                        <svg aria-hidden="true" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/>
                        </svg>
                        Halaman Sebelumnya
